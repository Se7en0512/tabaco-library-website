    ...
    <div className="min-h-screen">
      <section className="content-section py-20 px-6">
        ...
        <div className="container mx-auto max-w-6xl space-y-20">
          ...
          {/* Values Section */}
          <div className="border border-gray-200 bg-white shadow-sm p-10 md:p-12 rounded-xl">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">What We Value</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Accessibility for everyone</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Privacy and respectful service</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Reliable guidance for transactions</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Learning resources for all ages</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg text-gray-600">Community empowerment</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-indigo-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Technological innovation</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-pink-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Inclusive service delivery</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                  <span className="text-lg text-gray-600">Lifelong learning support</span>
                </div>
              </div>
            </div>
          </div>
