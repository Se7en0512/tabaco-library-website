      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-[var(--primary)] uppercase tracking-widest mb-3">E-Gov Services</p>
          ...
          {/* Requirements + Reminder (merged) */}
          <div className="border border-gray-200 bg-white shadow-sm rounded-xl p-6 max-w-4xl mx-auto mb-10">
            <h2 className="text-base font-bold text-[var(--primary)] mb-4">Before You Visit</h2>
